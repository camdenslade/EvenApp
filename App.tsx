...
type NavigationProps<T extends keyof RootStackParamList> = NativeStackScreenProps<RootStackParamList, T>;

function ScreenWrapper<P extends Record<string, any>, C extends Record<string, any>>({ Component, navProps, customProps }: {
